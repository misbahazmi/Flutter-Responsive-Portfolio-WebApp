  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(
            percentage: 0.8, title: 'MVVM', image: 'assets/icons/flutter.png'),
        AnimatedLinearProgressIndicator(
            percentage: 0.9,
            title: 'Clean Architecture',
            image: 'assets/icons/flutter.png'),
        AnimatedLinearProgressIndicator(
            percentage: 0.5, title: 'Kotlin', image: 'assets/icons/bloc.png'),
        AnimatedLinearProgressIndicator(
            percentage: 0.93, title: 'Dagger2', image: 'assets/icons/dart.png'),
      ],
    );
  }
}
